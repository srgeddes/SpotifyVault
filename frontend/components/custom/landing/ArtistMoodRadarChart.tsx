...
const moodData: MoodData[] = [
	{ timeOfDay: "Morning", "Billie Eilish": 35, "The Weeknd": 60, fullMark: 100 },
	{ timeOfDay: "Afternoon", "Billie Eilish": 45, "The Weeknd": 75, fullMark: 100 },
	{ timeOfDay: "Evening", "Billie Eilish": 65, "The Weeknd": 45, fullMark: 100 },
	{ timeOfDay: "Late Night", "Billie Eilish": 80, "The Weeknd": 25, fullMark: 100 },
];

const artistColors: { [key: string]: string } = {
	"Billie Eilish": "#4ADE80",
	"The Weeknd": "#F472B6",
};
		...
		<div className="relative">
			...
			<Card className="w-full h-full relative">
				...
				<CardContent className="pt-0">
					...
					<div className="text-xs text-gray-500 mt-2 text-center">Values represent average mood positivity (0-100) of songs</div>
				</CardContent>
			</Card>
		</div>
	);
